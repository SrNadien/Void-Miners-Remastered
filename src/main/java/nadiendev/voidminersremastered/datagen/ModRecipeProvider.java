...
public class ModRecipeProvider extends RecipeProvider {
    public static final ResourceKey<Level> MINING = ResourceKey.create(Registries.DIMENSION, ResourceLocation.fromNamespaceAndPath("allthemodium", "mining"));
    ...
    protected void buildRecipes(RecipeOutput pWriter) {
        ...
        RecipeOutput miningWriter = pWriter.withConditions(new ModLoadedCondition("allthemodium"));

        for (WeightedStack stack : OVERWORLD) {
            MinerRecipe.Builder.builder(stack.copy(), 1, MINING).save(miningWriter);
        }
        ...
        MinerRecipe.Builder.builder(new WeightedStack(Items.NETHER_QUARTZ_ORE, 6f), 1, MINING).save(miningWriter);
        MinerRecipe.Builder.builder(new WeightedStack(Items.ANCIENT_DEBRIS, 0.1f), 1, MINING).save(miningWriter);
        ...
        for (int i = 0; i < gemSets.size(); i++) {
            ...
            MinerRecipe.Builder.builder(new WeightedStack(set.CRYSTAL.get(), GEM_WEIGHT_OVERWORLD), tier, Level.OVERWORLD).save(pWriter);
            MinerRecipe.Builder.builder(new WeightedStack(set.CRYSTAL.get(), GEM_WEIGHT_NETHER), tier, Level.NETHER).save(pWriter);
            MinerRecipe.Builder.builder(new WeightedStack(set.CRYSTAL.get(), GEM_WEIGHT_MINING), tier, MINING).save(miningWriter);
        }
        ...
        ShapedRecipeBuilder.shaped(
                ...
                .unlockedBy("hasItem", has(ModItems.STORAGE_UPGRADE_MK1.get()))
                .save(pWriter);
        ...
        ShapedRecipeBuilder.shaped(
                ...
                .unlockedBy("hasItem", has(ModItems.STORAGE_UPGRADE_MK2.get()))
                .save(pWriter);
