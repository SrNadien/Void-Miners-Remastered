...
public class ModLanguageProvider extends LanguageProvider {
    ...
    protected void addTranslations() {
        ...
        this.add("tooltip.voidminers.face_configurator", "Right-click a face of a Miner or Solar Controller to set which side it outputs to.\nRight-click the same face again to turn it off.");
   ...
   public static class EsEs extends LanguageProvider {
        ...
        protected void addTranslations() {
            ...
            this.add("tooltip.voidminers.face_configurator", "Haz clic derecho en una cara del Controlador de Minero o Solar para elegir por qué lado saca.\nVuelve a hacer clic en la misma cara para desactivarlo.");
    ...
    public static class JaJp extends LanguageProvider {
        ...
        protected void addTranslations() {
            ...
            this.add("tooltip.voidminers.face_configurator", "マイナーまたはソーラーのコントローラーの面を右クリックすると、その面から搬出します。\n同じ面をもう一度右クリックすると解除されます。");
    ...
    public static class ZhCn extends LanguageProvider {
        ...
        protected void addTranslations() {
            ...
            this.add("tooltip.voidminers.face_configurator", "右键点击采矿机或太阳能控制器的一个面，即可从该面输出。\n再次右键点击同一个面则关闭。");
    ...
    public static class RuRu extends LanguageProvider {
        ...
        protected void addTranslations() {
            ...
            this.add("tooltip.voidminers.face_configurator", "ПКМ по грани контроллера шахтёра или солнечной панели, чтобы выводить через неё.\nПовторный ПКМ по той же грани отключает вывод.");
