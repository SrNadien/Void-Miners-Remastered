...
public class ModLanguageProvider extends LanguageProvider {
    ...
    protected void addTranslations() {
        ...
        this.add("tooltip.voidminersremastered.controller.export", "⇄ EXPORT: ");
        this.add("tooltip.voidminersremastered.controller.export.all_sides", "All sides (sneak + right-click a face to choose one)");
        this.add("client_message.voidminersremastered.export.all_sides", "Energy output set to all sides");
        this.add("tooltip.voidminersremastered.controller.export.none", "Disabled (sneak + right-click a face of the controller)");
        this.add("client_message.voidminersremastered.export.enabled", "Output export set to the %s face");
        this.add("client_message.voidminersremastered.export.disabled", "Output export disabled");
        this.add("tooltip.voidminersremastered.controller.export.side.down", "Bottom");
        this.add("tooltip.voidminersremastered.controller.export.side.up", "Top");
        this.add("tooltip.voidminersremastered.controller.export.side.north", "North");
        this.add("tooltip.voidminersremastered.controller.export.side.south", "South");
        this.add("tooltip.voidminersremastered.controller.export.side.west", "West");
        this.add("tooltip.voidminersremastered.controller.export.side.east", "East");
        this.add("tooltip.voidminersremastered.controller.halt_reason.block_before_glass", "There is a block between the Miner Controller and the Glass Panels, remove it for the Miner to work.");
        this.add("tooltip.voidminersremastered.controller.upgrade", "⚙ UPGRADES: ");
        this.add("tooltip.voidminersremastered.controller.upgrade.no_upgrade", "No upgrades applied.");
        this.add("tooltip.voidminersremastered.controller.upgrade.slots", " (+%d slots)");
        this.add("tooltip.voidminersremastered.controller.information", "Information : ");
        this.add("tooltip.voidminersremastered.controller.information.auto_export", "The outputs will be sent to adjacent inventories or voided if none are found / all are full.");
        this.add("jade.voidminersremastered.halt_reason.block_before_glass", "Reason: Block between Controller and Glass");
        this.add("gui.voidminersremastered.block_underneath", "Place this block at any Y level under the Miner Controller");
        this.add("gui.voidminersremastered.accepts_any", "Accepts any: %s");
        this.add("gui.voidminersremastered.weight", "Weight: %s");
        this.add("gui.voidminersremastered.chance", "Chance: %s%%");
        this.add("gui.voidminersremastered.only_one_recipe", "W: 1 (only recipe)");
        this.add("allthemodium.mining", "Mining Dimension");
        this.add("allthemodium.the_other", "The Other");
        this.add("allthemodium.the_beyond", "The Beyond");
        this.add("ad_astra.moon", "Moon");
        this.add("ad_astra.mars", "Mars");
        this.add("ad_astra.venus", "Venus");
        this.add("ad_astra.mercury", "Mercury");
        this.add("ad_astra.glacio", "Glacio");
        this.add("tooltip.voidminersremastered.controller.item.energy_per_tick", "Energy Per Tick: %s");
        this.add("tooltip.voidminersremastered.controller.item.duration", "Duration: %s ticks");
        this.add("tooltip.voidminersremastered.controller.item.energy_capacity", "Energy Capacity: %s");
        this.add("tooltip.voidminersremastered.controller.item.generation_per_tick", "Generation Per Tick: %s");
   ...
   public static class EsEs extends LanguageProvider {
        ...
        protected void addTranslations() {
            ...
            this.add("tooltip.voidminersremastered.controller.export", "⇄ EXPORTACIÓN: ");
            this.add("tooltip.voidminersremastered.controller.export.all_sides", "Todas las caras (agachado + clic derecho en una cara para elegirla)");
            this.add("client_message.voidminersremastered.export.all_sides", "Salida de energía en todas las caras");
            this.add("tooltip.voidminersremastered.controller.export.none", "Desactivada (agachado + clic derecho en una cara del controlador)");
            this.add("client_message.voidminersremastered.export.enabled", "Exportación de salida en la cara: %s");
            this.add("client_message.voidminersremastered.export.disabled", "Exportación de salida desactivada");
            this.add("tooltip.voidminersremastered.controller.export.side.down", "Abajo");
            this.add("tooltip.voidminersremastered.controller.export.side.up", "Arriba");
            this.add("tooltip.voidminersremastered.controller.export.side.north", "Norte");
            this.add("tooltip.voidminersremastered.controller.export.side.south", "Sur");
            this.add("tooltip.voidminersremastered.controller.export.side.west", "Oeste");
            this.add("tooltip.voidminersremastered.controller.export.side.east", "Este");
            this.add("tooltip.voidminersremastered.controller.halt_reason.block_before_glass", "Hay un bloque entre el Controlador del Minero y los Paneles de Cristal; quítalo para que el Minero funcione.");
            this.add("tooltip.voidminersremastered.controller.upgrade", "⚙ MEJORAS: ");
            this.add("tooltip.voidminersremastered.controller.upgrade.no_upgrade", "Sin mejoras aplicadas.");
            this.add("tooltip.voidminersremastered.controller.upgrade.slots", " (+%d espacios)");
            this.add("tooltip.voidminersremastered.controller.information", "Información: ");
            this.add("tooltip.voidminersremastered.controller.information.auto_export", "Los resultados se envían a los inventarios adyacentes, o se destruyen si no hay ninguno o están llenos.");
            this.add("jade.voidminersremastered.halt_reason.block_before_glass", "Motivo: Bloque entre el Controlador y el Cristal");
            this.add("gui.voidminersremastered.block_underneath", "Coloca este bloque a cualquier altura debajo del Controlador del Minero");
            this.add("gui.voidminersremastered.accepts_any", "Acepta cualquiera: %s");
            this.add("gui.voidminersremastered.weight", "Peso: %s");
            this.add("gui.voidminersremastered.chance", "Probabilidad: %s%%");
            this.add("gui.voidminersremastered.only_one_recipe", "P: 1 (única receta)");
            this.add("allthemodium.mining", "Dimensión de Minería");
            this.add("allthemodium.the_other", "The Other");
            this.add("allthemodium.the_beyond", "The Beyond");
            this.add("ad_astra.moon", "Luna");
            this.add("ad_astra.mars", "Marte");
            this.add("ad_astra.venus", "Venus");
            this.add("ad_astra.mercury", "Mercurio");
            this.add("ad_astra.glacio", "Glacio");
            this.add("tooltip.voidminersremastered.controller.item.energy_per_tick", "Energía por tick: %s");
            this.add("tooltip.voidminersremastered.controller.item.duration", "Duración: %s ticks");
            this.add("tooltip.voidminersremastered.controller.item.energy_capacity", "Capacidad de energía: %s");
            this.add("tooltip.voidminersremastered.controller.item.generation_per_tick", "Generación por tick: %s");
    ...
    public static class JaJp extends LanguageProvider {
        ...
        protected void addTranslations() {
            ...
            this.add("tooltip.voidminersremastered.controller.export", "⇄ 搬出: ");
            this.add("tooltip.voidminersremastered.controller.export.all_sides", "全ての面 (スニーク + 面を右クリックで選択)");
            this.add("client_message.voidminersremastered.export.all_sides", "エネルギー出力を全ての面に設定しました");
            this.add("tooltip.voidminersremastered.controller.export.none", "無効 (スニーク + コントローラーの面を右クリック)");
            this.add("client_message.voidminersremastered.export.enabled", "搬出先の面: %s");
            this.add("client_message.voidminersremastered.export.disabled", "搬出を無効にしました");
            this.add("tooltip.voidminersremastered.controller.export.side.down", "下");
            this.add("tooltip.voidminersremastered.controller.export.side.up", "上");
            this.add("tooltip.voidminersremastered.controller.export.side.north", "北");
            this.add("tooltip.voidminersremastered.controller.export.side.south", "南");
            this.add("tooltip.voidminersremastered.controller.export.side.west", "西");
            this.add("tooltip.voidminersremastered.controller.export.side.east", "東");
            this.add("tooltip.voidminersremastered.controller.halt_reason.block_before_glass", "マイナーコントローラーとガラスパネルの間にブロックがあります。取り除くとマイナーが動作します。");
            this.add("tooltip.voidminersremastered.controller.upgrade", "⚙ アップグレード: ");
            this.add("tooltip.voidminersremastered.controller.upgrade.no_upgrade", "アップグレードは適用されていません。");
            this.add("tooltip.voidminersremastered.controller.upgrade.slots", " (+%dスロット)");
            this.add("tooltip.voidminersremastered.controller.information", "情報: ");
            this.add("tooltip.voidminersremastered.controller.information.auto_export", "産出物は隣接するインベントリに送られます。見つからない、または満杯の場合は消滅します。");
            this.add("jade.voidminersremastered.halt_reason.block_before_glass", "理由: コントローラーとガラスの間にブロックがあります");
            this.add("gui.voidminersremastered.block_underneath", "このブロックをマイナーコントローラーの下の任意の高さに置いてください");
            this.add("gui.voidminersremastered.accepts_any", "いずれも可: %s");
            this.add("gui.voidminersremastered.weight", "重み: %s");
            this.add("gui.voidminersremastered.chance", "確率: %s%%");
            this.add("gui.voidminersremastered.only_one_recipe", "重み: 1 (唯一のレシピ)");
            this.add("allthemodium.mining", "採掘ディメンション");
            this.add("allthemodium.the_other", "The Other");
            this.add("allthemodium.the_beyond", "The Beyond");
            this.add("ad_astra.moon", "月");
            this.add("ad_astra.mars", "火星");
            this.add("ad_astra.venus", "金星");
            this.add("ad_astra.mercury", "水星");
            this.add("ad_astra.glacio", "グラシオ");
            this.add("tooltip.voidminersremastered.controller.item.energy_per_tick", "1tickあたりのエネルギー: %s");
            this.add("tooltip.voidminersremastered.controller.item.duration", "所要時間: %s tick");
            this.add("tooltip.voidminersremastered.controller.item.energy_capacity", "エネルギー容量: %s");
            this.add("tooltip.voidminersremastered.controller.item.generation_per_tick", "1tickあたりの発電量: %s");
    ...
    public static class ZhCn extends LanguageProvider {
        ...
        protected void addTranslations() {
            ...
            this.add("tooltip.voidminersremastered.controller.export", "⇄ 输出: ");
            this.add("tooltip.voidminersremastered.controller.export.all_sides", "所有面 (潜行 + 右键点击一个面来选择)");
            this.add("client_message.voidminersremastered.export.all_sides", "能量输出已设置为所有面");
            this.add("tooltip.voidminersremastered.controller.export.none", "已禁用 (潜行 + 右键点击控制器的一个面)");
            this.add("client_message.voidminersremastered.export.enabled", "输出面已设置为: %s");
            this.add("client_message.voidminersremastered.export.disabled", "已禁用输出");
            this.add("tooltip.voidminersremastered.controller.export.side.down", "下");
            this.add("tooltip.voidminersremastered.controller.export.side.up", "上");
            this.add("tooltip.voidminersremastered.controller.export.side.north", "北");
            this.add("tooltip.voidminersremastered.controller.export.side.south", "南");
            this.add("tooltip.voidminersremastered.controller.export.side.west", "西");
            this.add("tooltip.voidminersremastered.controller.export.side.east", "东");
            this.add("tooltip.voidminersremastered.controller.halt_reason.block_before_glass", "采矿机控制器与玻璃面板之间有方块，移除后采矿机才能工作。");
            this.add("tooltip.voidminersremastered.controller.upgrade", "⚙ 升级: ");
            this.add("tooltip.voidminersremastered.controller.upgrade.no_upgrade", "未应用升级。");
            this.add("tooltip.voidminersremastered.controller.upgrade.slots", " (+%d 格)");
            this.add("tooltip.voidminersremastered.controller.information", "信息: ");
            this.add("tooltip.voidminersremastered.controller.information.auto_export", "产物会被送入相邻的容器；若没有容器或容器已满则会被销毁。");
            this.add("jade.voidminersremastered.halt_reason.block_before_glass", "原因: 控制器与玻璃之间有方块");
            this.add("gui.voidminersremastered.block_underneath", "将此方块放在采矿机控制器下方的任意高度");
            this.add("gui.voidminersremastered.accepts_any", "接受任意: %s");
            this.add("gui.voidminersremastered.weight", "权重: %s");
            this.add("gui.voidminersremastered.chance", "概率: %s%%");
            this.add("gui.voidminersremastered.only_one_recipe", "权重: 1 (唯一配方)");
            this.add("allthemodium.mining", "采矿维度");
            this.add("allthemodium.the_other", "The Other");
            this.add("allthemodium.the_beyond", "The Beyond");
            this.add("ad_astra.moon", "月球");
            this.add("ad_astra.mars", "火星");
            this.add("ad_astra.venus", "金星");
            this.add("ad_astra.mercury", "水星");
            this.add("ad_astra.glacio", "格拉西奥");
            this.add("tooltip.voidminersremastered.controller.item.energy_per_tick", "每刻能耗: %s");
            this.add("tooltip.voidminersremastered.controller.item.duration", "耗时: %s 刻");
            this.add("tooltip.voidminersremastered.controller.item.energy_capacity", "能量容量: %s");
            this.add("tooltip.voidminersremastered.controller.item.generation_per_tick", "每刻发电: %s");
    ...
    public static class RuRu extends LanguageProvider {
        ...
        protected void addTranslations() {
            ...
            this.add("tooltip.voidminersremastered.controller.export", "⇄ ВЫВОД: ");
            this.add("tooltip.voidminersremastered.controller.export.all_sides", "Все грани (присесть + ПКМ по грани, чтобы выбрать)");
            this.add("client_message.voidminersremastered.export.all_sides", "Вывод энергии на все грани");
            this.add("tooltip.voidminersremastered.controller.export.none", "Отключён (присесть + ПКМ по грани контроллера)");
            this.add("client_message.voidminersremastered.export.enabled", "Вывод настроен на грань: %s");
            this.add("client_message.voidminersremastered.export.disabled", "Вывод отключён");
            this.add("tooltip.voidminersremastered.controller.export.side.down", "Низ");
            this.add("tooltip.voidminersremastered.controller.export.side.up", "Верх");
            this.add("tooltip.voidminersremastered.controller.export.side.north", "Север");
            this.add("tooltip.voidminersremastered.controller.export.side.south", "Юг");
            this.add("tooltip.voidminersremastered.controller.export.side.west", "Запад");
            this.add("tooltip.voidminersremastered.controller.export.side.east", "Восток");
            this.add("tooltip.voidminersremastered.controller.halt_reason.block_before_glass", "Между контроллером шахтёра и стеклянными панелями есть блок, уберите его, чтобы шахтёр заработал.");
            this.add("tooltip.voidminersremastered.controller.upgrade", "⚙ УЛУЧШЕНИЯ: ");
            this.add("tooltip.voidminersremastered.controller.upgrade.no_upgrade", "Улучшения не установлены.");
            this.add("tooltip.voidminersremastered.controller.upgrade.slots", " (+%d слотов)");
            this.add("tooltip.voidminersremastered.controller.information", "Информация: ");
            this.add("tooltip.voidminersremastered.controller.information.auto_export", "Добыча отправляется в соседние хранилища или уничтожается, если их нет или они заполнены.");
            this.add("jade.voidminersremastered.halt_reason.block_before_glass", "Причина: блок между контроллером и стеклом");
            this.add("gui.voidminersremastered.block_underneath", "Поставьте этот блок на любой высоте под контроллером шахтёра");
            this.add("gui.voidminersremastered.accepts_any", "Подходит любой: %s");
            this.add("gui.voidminersremastered.weight", "Вес: %s");
            this.add("gui.voidminersremastered.chance", "Шанс: %s%%");
            this.add("gui.voidminersremastered.only_one_recipe", "Вес: 1 (единственный рецепт)");
            this.add("allthemodium.mining", "Шахтёрское измерение");
            this.add("allthemodium.the_other", "The Other");
            this.add("allthemodium.the_beyond", "The Beyond");
            this.add("ad_astra.moon", "Луна");
            this.add("ad_astra.mars", "Марс");
            this.add("ad_astra.venus", "Венера");
            this.add("ad_astra.mercury", "Меркурий");
            this.add("ad_astra.glacio", "Гласио");
            this.add("tooltip.voidminersremastered.controller.item.energy_per_tick", "Энергия за тик: %s");
            this.add("tooltip.voidminersremastered.controller.item.duration", "Длительность: %s тиков");
            this.add("tooltip.voidminersremastered.controller.item.energy_capacity", "Ёмкость энергии: %s");
            this.add("tooltip.voidminersremastered.controller.item.generation_per_tick", "Генерация за тик: %s");
