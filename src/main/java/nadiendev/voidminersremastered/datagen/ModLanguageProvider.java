...
public class ModLanguageProvider extends LanguageProvider {
    ...
    protected void addTranslations() {
        ...
        this.add("tooltip.voidminers.controller.export", "⇄ EXPORT: ");
        this.add("tooltip.voidminers.controller.export.all_sides", "All sides (sneak + right-click a face to choose one)");
        this.add("client_message.voidminers.export.all_sides", "Energy output set to all sides");
        this.add("tooltip.voidminers.controller.export.none", "Disabled (sneak + right-click a face of the controller)");
        this.add("client_message.voidminers.export.enabled", "Output export set to the %s face");
        this.add("client_message.voidminers.export.disabled", "Output export disabled");
        this.add("tooltip.voidminers.controller.export.side.down", "Bottom");
        this.add("tooltip.voidminers.controller.export.side.up", "Top");
        this.add("tooltip.voidminers.controller.export.side.north", "North");
        this.add("tooltip.voidminers.controller.export.side.south", "South");
        this.add("tooltip.voidminers.controller.export.side.west", "West");
        this.add("tooltip.voidminers.controller.export.side.east", "East");
        this.add("tooltip.voidminers.controller.halt_reason.block_before_glass", "There is a block between the Miner Controller and the Glass Panels, remove it for the Miner to work.");
        ...
        this.add("jade.voidminers.halt_reason.block_before_glass", "Reason: Block between Controller and Glass");
        ...
        this.add("gui.voidminers.weight", "Weight: %s");
        this.add("gui.voidminers.chance", "Chance: %s%%");
   ...
   public static class EsEs extends LanguageProvider {
        ...
        protected void addTranslations() {
            ...
            this.add("client_message.voidminers.upgrades.upgrade_already_applied", "Ya se ha aplicado la misma mejora");
            this.add("client_message.voidminers.upgrades.max_storage.upgrade_already_applied_is_higher_tier", "No se puede aplicar una mejora de nivel inferior mientras haya instalada una de nivel superior");
            this.add("client_message.voidminers.upgrades.max_storage.upgrade_applied", "Mejora aplicada, Nivel: %d");
            this.add("config.jade.plugin_voidminers.void_miner", "VoidMiners");
            ...
            this.add("tooltip.voidminers.controller.export", "⇄ EXPORTACIÓN: ");
            this.add("tooltip.voidminers.controller.export.all_sides", "Todas las caras (agachado + clic derecho en una cara para elegirla)");
            this.add("client_message.voidminers.export.all_sides", "Salida de energía en todas las caras");
            this.add("tooltip.voidminers.controller.export.none", "Desactivada (agachado + clic derecho en una cara del controlador)");
            this.add("client_message.voidminers.export.enabled", "Exportación de salida en la cara: %s");
            this.add("client_message.voidminers.export.disabled", "Exportación de salida desactivada");
            this.add("tooltip.voidminers.controller.export.side.down", "Abajo");
            this.add("tooltip.voidminers.controller.export.side.up", "Arriba");
            this.add("tooltip.voidminers.controller.export.side.north", "Norte");
            this.add("tooltip.voidminers.controller.export.side.south", "Sur");
            this.add("tooltip.voidminers.controller.export.side.west", "Oeste");
            this.add("tooltip.voidminers.controller.export.side.east", "Este");
            this.add("tooltip.voidminers.controller.halt_reason.block_before_glass", "Hay un bloque entre el Controlador del Minero y los Paneles de Cristal; quítalo para que el Minero funcione.");
            this.add("tooltip.voidminers.controller.upgrade", "⚙ MEJORAS: ");
            this.add("tooltip.voidminers.controller.upgrade.no_upgrade", "Sin mejoras aplicadas.");
            this.add("tooltip.voidminers.controller.upgrade.slots", " (+%d espacios)");
            this.add("tooltip.voidminers.controller.information", "Información: ");
            this.add("tooltip.voidminers.controller.information.auto_export", "Los resultados se envían a los inventarios adyacentes, o se destruyen si no hay ninguno o están llenos.");
            this.add("jade.voidminers.halt_reason.block_before_glass", "Motivo: Bloque entre el Controlador y el Cristal");
            this.add("gui.voidminers.block_underneath", "Coloca este bloque a cualquier altura debajo del Controlador del Minero");
            this.add("gui.voidminers.accepts_any", "Acepta cualquiera: %s");
            this.add("gui.voidminers.weight", "Peso: %s");
            this.add("gui.voidminers.chance", "Probabilidad: %s%%");
            this.add("gui.voidminers.only_one_recipe", "P: 1 (única receta)");
    ...
    public static class JaJp extends LanguageProvider {
        ...
        protected void addTranslations() {
            ...
            this.add("client_message.voidminers.upgrades.upgrade_already_applied", "Same Upgrade already applied");
            this.add("client_message.voidminers.upgrades.max_storage.upgrade_already_applied_is_higher_tier", "Cannot apply lower-tier upgrade while a higher-tier upgrade is installed");
            this.add("client_message.voidminers.upgrades.max_storage.upgrade_applied", "Upgrade applied, Tier : %d");
            this.add("config.jade.plugin_voidminers.void_miner", "VoidMiners");
            ...
            this.add("tooltip.voidminers.controller.export", "⇄ 搬出: ");
            this.add("tooltip.voidminers.controller.export.all_sides", "全ての面 (スニーク + 面を右クリックで選択)");
            this.add("client_message.voidminers.export.all_sides", "エネルギー出力を全ての面に設定しました");
            this.add("tooltip.voidminers.controller.export.none", "無効 (スニーク + コントローラーの面を右クリック)");
            this.add("client_message.voidminers.export.enabled", "搬出先の面: %s");
            this.add("client_message.voidminers.export.disabled", "搬出を無効にしました");
            this.add("tooltip.voidminers.controller.export.side.down", "下");
            this.add("tooltip.voidminers.controller.export.side.up", "上");
            this.add("tooltip.voidminers.controller.export.side.north", "北");
            this.add("tooltip.voidminers.controller.export.side.south", "南");
            this.add("tooltip.voidminers.controller.export.side.west", "西");
            this.add("tooltip.voidminers.controller.export.side.east", "東");
            this.add("tooltip.voidminers.controller.halt_reason.block_before_glass", "マイナーコントローラーとガラスパネルの間にブロックがあります。取り除くとマイナーが動作します。");
            this.add("tooltip.voidminers.controller.upgrade", "⚙ アップグレード: ");
            this.add("tooltip.voidminers.controller.upgrade.no_upgrade", "アップグレードは適用されていません。");
            this.add("tooltip.voidminers.controller.upgrade.slots", " (+%dスロット)");
            this.add("tooltip.voidminers.controller.information", "情報: ");
            this.add("tooltip.voidminers.controller.information.auto_export", "産出物は隣接するインベントリに送られます。見つからない、または満杯の場合は消滅します。");
            this.add("jade.voidminers.halt_reason.block_before_glass", "理由: コントローラーとガラスの間にブロックがあります");
            this.add("gui.voidminers.block_underneath", "このブロックをマイナーコントローラーの下の任意の高さに置いてください");
            this.add("gui.voidminers.accepts_any", "いずれも可: %s");
            this.add("gui.voidminers.weight", "重み: %s");
            this.add("gui.voidminers.chance", "確率: %s%%");
            this.add("gui.voidminers.only_one_recipe", "重み: 1 (唯一のレシピ)");
    ...
    public static class ZhCn extends LanguageProvider {
        ...
        protected void addTranslations() {
            ...
            this.add("tooltip.voidminers.controller.export", "⇄ 输出: ");
            this.add("tooltip.voidminers.controller.export.all_sides", "所有面 (潜行 + 右键点击一个面来选择)");
            this.add("client_message.voidminers.export.all_sides", "能量输出已设置为所有面");
            this.add("tooltip.voidminers.controller.export.none", "已禁用 (潜行 + 右键点击控制器的一个面)");
            this.add("client_message.voidminers.export.enabled", "输出面已设置为: %s");
            this.add("client_message.voidminers.export.disabled", "已禁用输出");
            this.add("tooltip.voidminers.controller.export.side.down", "下");
            this.add("tooltip.voidminers.controller.export.side.up", "上");
            this.add("tooltip.voidminers.controller.export.side.north", "北");
            this.add("tooltip.voidminers.controller.export.side.south", "南");
            this.add("tooltip.voidminers.controller.export.side.west", "西");
            this.add("tooltip.voidminers.controller.export.side.east", "东");
            this.add("tooltip.voidminers.controller.halt_reason.block_before_glass", "采矿机控制器与玻璃面板之间有方块，移除后采矿机才能工作。");
            this.add("tooltip.voidminers.controller.upgrade", "⚙ 升级: ");
            this.add("tooltip.voidminers.controller.upgrade.no_upgrade", "未应用升级。");
            this.add("tooltip.voidminers.controller.upgrade.slots", " (+%d 格)");
            this.add("tooltip.voidminers.controller.information", "信息: ");
            this.add("tooltip.voidminers.controller.information.auto_export", "产物会被送入相邻的容器；若没有容器或容器已满则会被销毁。");
            this.add("jade.voidminers.halt_reason.block_before_glass", "原因: 控制器与玻璃之间有方块");
            this.add("gui.voidminers.block_underneath", "将此方块放在采矿机控制器下方的任意高度");
            this.add("gui.voidminers.accepts_any", "接受任意: %s");
            this.add("gui.voidminers.weight", "权重: %s");
            this.add("gui.voidminers.chance", "概率: %s%%");
            this.add("gui.voidminers.only_one_recipe", "权重: 1 (唯一配方)");
    ...
    public static class RuRu extends LanguageProvider {
        ...
        protected void addTranslations() {
            ...
            this.add("tooltip.voidminers.controller.export", "⇄ ВЫВОД: ");
            this.add("tooltip.voidminers.controller.export.all_sides", "Все грани (присесть + ПКМ по грани, чтобы выбрать)");
            this.add("client_message.voidminers.export.all_sides", "Вывод энергии на все грани");
            this.add("tooltip.voidminers.controller.export.none", "Отключён (присесть + ПКМ по грани контроллера)");
            this.add("client_message.voidminers.export.enabled", "Вывод настроен на грань: %s");
            this.add("client_message.voidminers.export.disabled", "Вывод отключён");
            this.add("tooltip.voidminers.controller.export.side.down", "Низ");
            this.add("tooltip.voidminers.controller.export.side.up", "Верх");
            this.add("tooltip.voidminers.controller.export.side.north", "Север");
            this.add("tooltip.voidminers.controller.export.side.south", "Юг");
            this.add("tooltip.voidminers.controller.export.side.west", "Запад");
            this.add("tooltip.voidminers.controller.export.side.east", "Восток");
            this.add("tooltip.voidminers.controller.halt_reason.block_before_glass", "Между контроллером шахтёра и стеклянными панелями есть блок, уберите его, чтобы шахтёр заработал.");
            this.add("tooltip.voidminers.controller.upgrade", "⚙ УЛУЧШЕНИЯ: ");
            this.add("tooltip.voidminers.controller.upgrade.no_upgrade", "Улучшения не установлены.");
            this.add("tooltip.voidminers.controller.upgrade.slots", " (+%d слотов)");
            this.add("tooltip.voidminers.controller.information", "Информация: ");
            this.add("tooltip.voidminers.controller.information.auto_export", "Добыча отправляется в соседние хранилища или уничтожается, если их нет или они заполнены.");
            this.add("jade.voidminers.halt_reason.block_before_glass", "Причина: блок между контроллером и стеклом");
            this.add("gui.voidminers.block_underneath", "Поставьте этот блок на любой высоте под контроллером шахтёра");
            this.add("gui.voidminers.accepts_any", "Подходит любой: %s");
            this.add("gui.voidminers.weight", "Вес: %s");
            this.add("gui.voidminers.chance", "Шанс: %s%%");
            this.add("gui.voidminers.only_one_recipe", "Вес: 1 (единственный рецепт)");
