...
public class ModLanguageProvider extends LanguageProvider {
    ...
    protected void addTranslations() {
        ...
        this.add(ModItems.STORAGE_UPGRADE_MK1.get(), "Storage Upgrade MK1");
        this.add(ModItems.STORAGE_UPGRADE_MK2.get(), "Storage Upgrade MK2");
        this.add(ModItems.STORAGE_UPGRADE_MK3.get(), "Storage Upgrade MK3");
        ...
        this.add(ModItems.FACE_CONFIGURATOR.get(), "Face Configurator");
        this.add("tooltip.voidminersremastered.face_configurator", "Right-click a face of a Miner or Solar Controller to set which side it outputs to.\nRight-click the same face again to turn it off.");
   ...
   public static class EsEs extends LanguageProvider {
        ...
        protected void addTranslations() {
            ...
            this.add("item.voidminersremastered.max_storage_upgrade_t1", "Mejora de Almacenamiento MK1");
            this.add("item.voidminersremastered.max_storage_upgrade_t2", "Mejora de Almacenamiento MK2");
            this.add("item.voidminersremastered.max_storage_upgrade_t3", "Mejora de Almacenamiento MK3");
            ...
            this.add("item.voidminersremastered.face_configurator", "Configurador de Caras");
            this.add("tooltip.voidminersremastered.face_configurator", "Haz clic derecho en una cara del Controlador de Minero o Solar para elegir por qué lado saca.\nVuelve a hacer clic en la misma cara para desactivarlo.");
    ...
    public static class JaJp extends LanguageProvider {
        ...
        protected void addTranslations() {
            ...
            this.add("item.voidminersremastered.max_storage_upgrade_t1", "Storage Upgrade MK1");
            this.add("item.voidminersremastered.max_storage_upgrade_t2", "Storage Upgrade MK2");
            this.add("item.voidminersremastered.max_storage_upgrade_t3", "Storage Upgrade MK3");
            ...
            this.add("item.voidminersremastered.face_configurator", "面コンフィギュレーター");
            this.add("tooltip.voidminersremastered.face_configurator", "マイナーまたはソーラーのコントローラーの面を右クリックすると、その面から搬出します。\n同じ面をもう一度右クリックすると解除されます。");
    ...
    public static class ZhCn extends LanguageProvider {
        ...
        protected void addTranslations() {
            ...
            this.add("item.voidminersremastered.face_configurator", "面配置器");
            this.add("tooltip.voidminersremastered.face_configurator", "右键点击采矿机或太阳能控制器的一个面，即可从该面输出。\n再次右键点击同一个面则关闭。");
    ...
    public static class RuRu extends LanguageProvider {
        ...
        protected void addTranslations() {
            ...
            this.add("item.voidminersremastered.face_configurator", "Настройщик граней");
            this.add("tooltip.voidminersremastered.face_configurator", "ПКМ по грани контроллера шахтёра или солнечной панели, чтобы выводить через неё.\nПовторный ПКМ по той же грани отключает вывод.");
