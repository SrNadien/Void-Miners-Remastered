...
The current mod ID is `voidminersremastered`. KubeJS recipes must therefore use the
`voidminersremastered` recipe namespace.
...
The generated recipe type is:

```text
voidminersremastered:miner
```
...
```javascript
event.recipes.voidminersremastered.miner('minecraft:netherrack', 'minecraft:the_nether', 1)
    .weight(30.0)
    .count(8);
```
...
```javascript
event.recipes.voidminersremastered.miner('minecraft:end_stone', 'minecraft:the_end', 2)
    .weight(25.0)
    .count(12);
```
...
```javascript
event.recipes.voidminersremastered.miner('thermal:silver_ingot', 'minecraft:overworld', 2)
    .weight(6.0)
    .count(2);
```
...
ServerEvents.recipes(event => {
    ...
    event.recipes.voidminersremastered.miner('minecraft:lapis_lazuli', 'minecraft:overworld', 2)
        .weight(8.0)
        .count(6);
    ...
    event.recipes.voidminersremastered.miner('minecraft:glowstone_dust', 'minecraft:the_nether', 2)
        .weight(10.0)
        .count(8);
    ...
    event.recipes.voidminersremastered.miner('minecraft:chorus_fruit', 'minecraft:the_end', 3)
        .weight(8.0)
        .count(4);
